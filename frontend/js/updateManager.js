        ...
        wrapper.innerHTML = `
            ...
            <div id="new-update-view" class="update-view-overlay">
                <div class="update-view-header">
                    ...
                    <h2 class="update-header-title" id="updateHeaderTitle">New update v1.5.5</h2>
                </div>

                <div class="update-view-body" id="updateViewBody">
                    <div class="update-meta-info" id="updateMetaInfo">
                        <p>Released on: 25 August 2026, 02:25 pm</p>
                        <p>Size: 2.8 MB</p>
                        <p>SW Cache: vibentra-cache-v92</p>
                    </div>
                    ...
                    <div class="update-important-block" id="updateImportantBlock">
                        ...
                        Enforced global mobile responsiveness across all views (Home, Search, Playlists, Profile, Settings, Vibe AI, Connect, and Auth).
                    </div>
